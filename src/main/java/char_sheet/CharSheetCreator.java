...
public class CharSheetCreator {
    ...
    public Map<String, String> createFieldsMap() {
        ...
        map.put("STRmod", String.valueOf(character.getAttributes().getModifier(Attribute.STR)));
        map.put("DEX", String.valueOf(character.getAttributes().getAttribute(Attribute.DEX)));
        map.put("DEXmod ", String.valueOf(character.getAttributes().getModifier(Attribute.DEX)));
        map.put("CON", String.valueOf(character.getAttributes().getAttribute(Attribute.CON)));
        map.put("CONmod", String.valueOf(character.getAttributes().getModifier(Attribute.CON)));
        map.put("INT", String.valueOf(character.getAttributes().getAttribute(Attribute.INT)));
        map.put("INTmod", String.valueOf(character.getAttributes().getModifier(Attribute.INT)));
        map.put("WIS", String.valueOf(character.getAttributes().getAttribute(Attribute.WIS)));
        map.put("WISmod", String.valueOf(character.getAttributes().getModifier(Attribute.WIS)));
        map.put("CHA", String.valueOf(character.getAttributes().getAttribute(Attribute.CHA)));
        map.put("CHAmod", String.valueOf(character.getAttributes().getModifier(Attribute.CHA)));

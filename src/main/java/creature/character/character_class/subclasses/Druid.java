...
public class Druid extends CharacterClass {
    public Druid() {
        ...
        addArmorAndWeaponProficiency(ArmorCategory.LIGHT_ARMOR, ArmorCategory.MEDIUM_ARMOR, ArmorCategory.SHIELD, new Club(), new Dagger(), new Dart(), new Javelin(), new Mace(), new Quarterstaff(), new Scimitar(), new Sickle(), new Sling(), new Spear());
    }
}

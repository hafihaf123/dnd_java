...
public class Fighter extends CharacterClass {
    public Fighter() {
        ...
        addArmorAndWeaponProficiency(ArmorCategory.LIGHT_ARMOR, ArmorCategory.MEDIUM_ARMOR, ArmorCategory.HEAVY_ARMOR, ArmorCategory.SHIELD, WeaponType.SIMPLE, WeaponType.MARTIAL);
    }
}
